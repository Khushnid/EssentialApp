...
//  EssentialFeedTests
//
//  Created by Khushnidjon on 27/06/23.
//

import XCTest

func assertLocalizedKeyAndValueExistInBundle(in presentationBundle: Bundle, _ table: String, file: StaticString = #file, line: UInt = #line) {
